...
# requires vcf
cd /xdisk/mcnew/dannyjackson/cardinals/vcf_likelihoods/subsets/

module load bcftools 

bcftools convert noca_urban.bcf  -o noca_urban.vcf -O v 
bcftools convert noca_rural.bcf  -o noca_rural.vcf -O v 
bcftools convert pyrr_urban.bcf  -o pyrr_urban.vcf -O v 
bcftools convert pyrr_rural.bcf  -o pyrr_rural.vcf -O v 

grep 'CHROM' noca_urban.vcf

#!/bin/bash

#SBATCH --job-name=raisd_noca
#SBATCH --ntasks=1
#SBATCH --nodes=1             
...
#SBATCH --output=output.raisd_noca.%j

cd /xdisk/mcnew/dannyjackson/cardinals/raisd

/home/u15/dannyjackson/programs/RAiSD/raisd-master/RAiSD -n noca_urban -I /xdisk/mcnew/dannyjackson/cardinals/vcf_likelihoods/subsets/noca_urban.vcf -f -O -R -P -a 1500 -C /xdisk/mcnew/dannyjackson/cardinals/reference_dataset/ncbi_dataset/data/GCA_013397215.1/GCA_013397215.1_ASM1339721v1_genomic.fna

mkdir /xdisk/mcnew/dannyjackson/cardinals/raisd/noca/urban

mkdir /xdisk/mcnew/dannyjackson/cardinals/raisd/noca/rural /xdisk/mcnew/dannyjackson/cardinals/raisd/pyrr/urban /xdisk/mcnew/dannyjackson/cardinals/raisd/pyrr/rural

#!/bin/bash

#SBATCH --job-name=raisd_noca_rural
#SBATCH --ntasks=1
#SBATCH --nodes=1             
#SBATCH --time=50:00:00   
#SBATCH --partition=standard
...
#SBATCH --mail-type=ALL
#SBATCH --mail-user=dannyjackson@arizona.edu
#SBATCH --output=output.raisd_noca_rural.%j

cd /xdisk/mcnew/dannyjackson/cardinals/raisd/noca/rural

/home/u15/dannyjackson/programs/RAiSD/raisd-master/RAiSD -n noca_rural -I /xdisk/mcnew/dannyjackson/cardinals/vcf_likelihoods/subsets/noca_rural.vcf -f -O -R -P -a 1500 -C /xdisk/mcnew/dannyjackson/cardinals/reference_dataset/ncbi_dataset/data/GCA_013397215.1/GCA_013397215.1_ASM1339721v1_genomic.fna

sbatch raisd_noca_rural.sh 
Submitted batch job 3410258

#!/bin/bash

#SBATCH --job-name=raisd_pyrr_urban
#SBATCH --ntasks=1
#SBATCH --nodes=1             
#SBATCH --time=50:00:00   
#SBATCH --partition=standard
...
#SBATCH --mail-type=ALL
#SBATCH --mail-user=dannyjackson@arizona.edu
#SBATCH --output=output.raisd_pyrr_urban.%j

cd /xdisk/mcnew/dannyjackson/cardinals/raisd/pyrr/urban

/home/u15/dannyjackson/programs/RAiSD/raisd-master/RAiSD -n pyrr_urban -I /xdisk/mcnew/dannyjackson/cardinals/vcf_likelihoods/subsets/pyrr_urban.vcf -f -O -R -P -a 1500 -C /xdisk/mcnew/dannyjackson/cardinals/reference_dataset/ncbi_dataset/data/GCA_013397215.1/GCA_013397215.1_ASM1339721v1_genomic.fna

sbatch raisd_pyrr_urban.sh 
Submitted batch job 3410260

#!/bin/bash

#SBATCH --job-name=raisd_pyrr_rural
#SBATCH --ntasks=1
#SBATCH --nodes=1             
#SBATCH --time=50:00:00   
#SBATCH --partition=standard
...
#SBATCH --mail-type=ALL
#SBATCH --mail-user=dannyjackson@arizona.edu
#SBATCH --output=output.raisd_pyrr_rural.%j

cd /xdisk/mcnew/dannyjackson/cardinals/raisd/pyrr/rural

/home/u15/dannyjackson/programs/RAiSD/raisd-master/RAiSD -n pyrr_rural -I /xdisk/mcnew/dannyjackson/cardinals/vcf_likelihoods/subsets/pyrr_rural.vcf -f -O -R -P -a 1500 -C /xdisk/mcnew/dannyjackson/cardinals/reference_dataset/ncbi_dataset/data/GCA_013397215.1/GCA_013397215.1_ASM1339721v1_genomic.fna

sbatch raisd_pyrr_rural.sh 
Submitted batch job 3410259
