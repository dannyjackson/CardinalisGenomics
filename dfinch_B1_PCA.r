...
~/programs/angsd/angsd -vcf-gl genolike.bcf -doPlink 2 -out genolike_plink -doGeno -1 -dopost 1 -domaf 1 -doMajorMinor 1 -sites /xdisk/mcnew/dannyjackson/cardinals_dfinch/referencelists/sites_headless.mafs


plink --tped /xdisk/mcnew/dannyjackson/cardinals_dfinch/vcf_likelihoods/all/genolike_plink.tped --tfam /xdisk/mcnew/dannyjackson/cardinals_dfinch/vcf_likelihoods/all/genolike_plink.tfam --allow-extra-chr --snps-only 'just-acgt' --indep-pairwise 50kb 1 0.5 --out genolike_filtered

plink --tped /xdisk/mcnew/dannyjackson/cardinals_dfinch/vcf_likelihoods/all/genolike_plink.tped --tfam /xdisk/mcnew/dannyjackson/cardinals_dfinch/vcf_likelihoods/all/genolike_plink.tfam --allow-extra-chr --snps-only 'just-acgt' --extract genolike_filtered.prune.in --out genolike_pruned --make-bed 
...
pcangsd -b /xdisk/mcnew/dannyjackson/cardinals_dfinch/datafiles/vcf_likelihoods/all/genolike.beagle.gz -o /xdisk/mcnew/dannyjackson/cardinals_dfinch/analyses/pca/all -t 12 -e 2 --selection --pcadapt --sites_save --snp_weights

# for pop gen
pcangsd -p /xdisk/mcnew/dannyjackson/cardinals_dfinch/datafiles/vcf_likelihoods/all/genolike_pruned -o /xdisk/mcnew/dannyjackson/cardinals_dfinch/analyses/pca/pruned -t 12 -e 2 --selection --admix
